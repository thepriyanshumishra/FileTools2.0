...
This file covers how to run FileTools under a Docker container.
...
```shell
$ git clone https://github.com/FileTools-sh/FileTools
$ cd FileTools/
```
...
$ docker build -t vert-sh/vert \
    ...
    --build-arg PUB_HOSTNAME=filetools.app \
    --build-arg PUB_PLAUSIBLE_URL=https://plausible.example.com \
    --build-arg PUB_FileToolsD_URL=https://filetoolsd.filetools.app \
    --build-arg PUB_DONATION_URL=https://donations.filetools.app \
